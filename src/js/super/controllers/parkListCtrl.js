 ...
 */
"use strict";
angular.module('ZJSY_SuperAdmin').controller('ParkListController', function($scope,$http,$state,$stateParams,$location,$rootScope){
    ...
    var infoListApi = X_context.api + "info/listParkShow";
    var deleteInfoApi = X_context.api + "info/delParkInfo";
