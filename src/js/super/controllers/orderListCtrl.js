 ...
 */
"use strict";
angular.module('ZJSY_SuperAdmin').controller('OrderListController', function($scope,$http,$state,$stateParams,$location,Upload,$rootScope){
    ...
    var orderListApi = X_context.api + "servicesOrder/listCommercial";
