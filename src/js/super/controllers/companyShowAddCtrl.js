 ...
 */
"use strict";
angular.module('ZJSY_SuperAdmin').controller('CompanyShowAddController', function($scope,$http,$state,$stateParams,Upload,$location,$rootScope,$q){

    var one = false;

    var addInfoApi = X_context.api + "info/addCompanyInfo";
