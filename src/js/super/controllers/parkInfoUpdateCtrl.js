 ...
 */
"use strict";
angular.module('ZJSY_SuperAdmin').controller('ParkInfoUpdateController', function($scope,$http,$state,$stateParams,Upload,$location,$rootScope,$q){

    $scope.title = "";
    $scope.subtitle = "";
    $scope.image = "";

    $scope.id = $stateParams.infoId;

    var getInfoListApi= X_context.api + "info/getInfoDetail";
    var infoUpdateApi = X_context.api + "info/updateParkInfo";
