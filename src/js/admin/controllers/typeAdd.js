 ...
 */
"use strict";
angular.module('ZJSY_Admin').controller('TypeAddController', function($scope,$http,$state,$rootScope){
    ...
    $scope.update = function(categoryName,id,isShow,sort){
        ...
        if(!categoryName)return $rootScope.$broadcast('alerts',{type:'danger',message:"请正确输入分类！"});
