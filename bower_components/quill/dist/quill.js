...
LinkTooltip = (function(superClass) {
  ...
  LinkTooltip.DEFAULTS = {
    maxLength: 50,
    template: '<span class="title">链接:&nbsp;</span> <a href="#" class="url" target="_blank" href="about:blank"></a> <input class="input" type="text"> <span>&nbsp;&#45;&nbsp;</span> <a href="javascript:;" class="change">修改</a> <a href="javascript:;" class="remove">删除</a> <a href="javascript:;" class="done">完成</a>'
  };
